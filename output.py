...
class output():
    def __init__(self):
        ...
        self.lcd_d4        = digitalio.DigitalInOut(board.D27)
        self.lcd_d5        = digitalio.DigitalInOut(board.D22)
        self.lcd_d6        = digitalio.DigitalInOut(board.D24)
        self.lcd_d7        = digitalio.DigitalInOut(board.D25)
        self.lcd_columns = 16
        self.lcd_rows = 2
