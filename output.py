...
class output():
    def __init__(self):
        ...
        self.lcd_en        = digitalio.DigitalInOut(board.D26)
        self.lcd_d4        = digitalio.DigitalInOut(board.D26)
        self.lcd_d5        = digitalio.DigitalInOut(board.D26)
        self.lcd_d6        = digitalio.DigitalInOut(board.D26)
